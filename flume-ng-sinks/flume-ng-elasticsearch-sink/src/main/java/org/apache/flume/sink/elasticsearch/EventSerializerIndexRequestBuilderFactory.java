...
/**
 * Default implementation of {@link ElasticSearchIndexRequestBuilderFactory}. It
 * serializes flume events using the {@link ElasticSearchEventSerializer}
...
public class EventSerializerIndexRequestBuilderFactory extends AbstractElasticSearchIndexRequestBuilderFactory {
	...
	protected void prepareIndexRequest(IndexRequestBuilder indexRequest, String indexName, String indexType, Event event) throws IOException {
		...
		indexRequest.setIndex(indexName).setType(indexType).setSource(build);
	}
}
