...
public class MyESClient implements ElasticSearchClient {
	public static final Logger logger = LoggerFactory.getLogger(MyESClient.class);
	...
	public MyESClient(String[] hostNames, String clusterName, ElasticSearchEventSerializer serializer) {
...
//		logger.info("the indexname is {},the indextype is {}", indexName, indexType);
	...
	public void execute() throws Exception {
		try {
			...
			logger.info("sent to es ,the status is {}", bulkResponse.status());
